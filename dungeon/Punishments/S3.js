...
switch(getVar("Punisher")) {
	...
	break;
	case 2 :
	sendDungeonMessage(" Contacting %DomHonorific% %Contact1% ..",1);
	setSender(2);
	break;
	case 3 :
	sendDungeonMessage(" Contacting %DomHonorific% %Contact2% ..",1);
	setSender(3);
	break;
	case 4 :
	sendDungeonMessage(" Contacting %DomHonorific% %Contact3% ..",1);
	setSender(4);
...
switch (choice) {
   ...
   case 2:
	...
	//(CornerTime1)
	donetime = getdate().addseconds(CornerTimeCounter);
	while( getDate().isBefore(donetime)) {
