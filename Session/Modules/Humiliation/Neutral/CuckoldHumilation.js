{
    //Skip and find another module TODO: Ask if never asked before
    if(getCuckoldLimit() != LIMIT_ASKED_YES) {
        ...
        if (tryRunModuleFetchId()) {
            ...
            sendMessage(random('You are my cuckold!', 'Your dick is useless', 'Your pathetic cock has no you use to me!'));
            ...
            playVideo('Videos/Spicy/Modules/CuckoldAndDenied/*.mp4', true);
