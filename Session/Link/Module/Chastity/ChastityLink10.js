{
    if (tryRunLinkFetchId()) {
        ...
        showCategoryImage('BOOBS', 4);
        sendMessage("Maybe that would ease the pain a little bit");
        sendMessage("But even that is out of your reach");
        sendMessage("All you can do is wait and pray that I will let you %JerkOff% again");
    }
}
