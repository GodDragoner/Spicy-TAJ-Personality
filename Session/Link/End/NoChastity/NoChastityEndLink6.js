{
    if (tryRunEndLinkFetchId()) {
        ...
        sendMessage('I guess that wasn\'t the one %Lol%');
        sendMessage('But %MyCock% %Cock% is throbbing so fucking much right now, isn\'t it...');
        sendMessage('So what should we do about that');
    }
}
